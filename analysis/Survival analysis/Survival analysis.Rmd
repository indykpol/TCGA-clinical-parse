...
```{r}
# getwd()
write.table(candidate_combinations, file="1+samples_FredrikksonSignif_survival_uniqGenes_acrossTypesCombinations.tab", sep="\t", quote=FALSE)
```
